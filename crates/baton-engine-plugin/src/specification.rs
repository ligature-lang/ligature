...
pub mod prelude {
    pub use super::{
        BuildStatus, ErrorSeverity, GenericSpecification, SpecFileInfo, SpecFileType,
        SpecStatistics, ValidationError, ValidationErrorType, ValidationResult, ValidationWarning,
