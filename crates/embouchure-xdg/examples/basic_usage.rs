...
async fn main() -> MainResult {
    ...
    println!(
        "   Default config file: {}",
        config_manager.default_filename()
    );
    println!(
        "   Config path: {}",
        config_manager.default_config_path()?.display()
    );
    println!();
    ...
    println!(
        "   Created directories for component: {}",
        paths.component()
    );
    ...
    println!(
        "   Config file: {}",
        paths.config_file("settings.json")?.display()
    );
    println!("   Data file: {}", paths.data_file("data.db")?.display());
    println!(
        "   Cache file: {}",
        paths.cache_file("cache.dat")?.display()
    );
    println!(
        "   State file: {}",
        paths.state_file("state.json")?.display()
    );
    println!();
