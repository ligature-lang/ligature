...
fn test_arithmetic_performance() -> AstResult<()> {
    ...
    println!("Result: {:?}", evaluator.evaluate_expression(&arithmetic_expr)?);
...
fn test_value_creation_performance() -> AstResult<()> {
    ...
    println!("Integer value creation: {:.0} ops/sec", iterations as f64 / int_duration.as_secs_f64());
    println!("String value creation: {:.0} ops/sec", iterations as f64 / string_duration.as_secs_f64());
