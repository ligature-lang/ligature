...
- **[XDG Integration Guide](../user-guide/configuration/xdg-integration.md)** - Complete user guide covering:
...
- **[XDG Integration Quick Reference](../user-guide/configuration/xdg-integration-quick-reference.md)** - Developer-focused guide covering:
...
1. Read the **[XDG Integration Guide](../user-guide/configuration/xdg-integration.md)**
...
1. Read the **[XDG Integration Quick Reference](../user-guide/configuration/xdg-integration-quick-reference.md)**
...
- Start with the **[XDG Integration Guide](../user-guide/configuration/xdg-integration.md)** for user-oriented information
- Use the **[Quick Reference](../user-guide/configuration/xdg-integration-quick-reference.md)** for development tasks
